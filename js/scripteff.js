...
//QUESTION BOX
var questionsEff = ["What is the principal effect produced by an Allosteric Antagonist (affecting agonist efficacy) antagonist on an agonist dose-response curve?<br><i>This can be tested using the Visualiser</i>",
...
function revealAnswerEff() {
    document.getElementById("EffAnswer").innerHTML = answersEff[questionCounterEff];
    $('#EffAnswerModal').modal('show');
}


function nextQuestionEff() {
    if (questionCounterEff + 1 == questionsEff.length) { //end of questions
