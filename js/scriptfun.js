...
var questionsFun = ["What is the principal effect produced by a Functional Antagonist on an agonist dose-response curve?<br><i>This can be tested using the Visualiser</i>",
    ...
    "Is the effect of a Functional Antagonist influenced by the properties of the agonist (Affinity, Intrinsic Efficacy) or the cell (R<sub>T</sub>, <i>&#947</i>) ?<br><i>This can be tested using the Visualiser</i>",
