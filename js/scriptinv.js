...
"YES, but this depends on the relative properties of the inverse agonist, receptor and cell.  An inverse agonist is more likely to abolish constitutive receptor activity if:<br>(1) the inverse agonist is highly selective for the inactive receptor (low&#945value)<br>(2) inverse agonist reduces the affinity of the receptor for the G protein (low&#947value)<br>(3) the initial level of constitutive receptor activity is low (relatively low L value, low [R] and/or [G], low affinity of receptor for G protein).",
