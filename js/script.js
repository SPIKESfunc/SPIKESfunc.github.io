...
var questionsAgonist = ["What is agonism?",
    ...
    "Is INTRINSIC EFFICACY required for an agonist to induce an effect?<br><i>This can be tested using the Visualiser</i>",
    "Are RECEPTORS required for an agonist to induce an effect?<br><i>This can be tested using the Visualiser</i>",
    "Is SIGNAL AMPLIFICATION required for an agonist to induce an effect?<br><i>This can be tested using the Visualiser</i>",
    "What is agonist POTENCY?",
    "What is a PARTIAL agonist?",
    "What is a FULL agonist?",
    "For a partial agonist, increasing which of the following variables will increase the maximum effect produced – intrinsic efficacy (ε), receptor density (R<sub>T</sub>) or signal amplification (<i>&#947</i>)? <br><i>This can be tested using the Visualiser</i>",
    "For a full agonist, does INCREASING intrinsic efficacy (ε), receptor density (R<sub>T</sub>) and/or signal amplification (<i>&#947</i>) produce a noticeable INCREASE in maximum effect produced? <br><i>This can be tested using the Visualiser</i>", 
...
var answersAgonist = ["Agonism is the process via which a ligand called the agonist binds to a receptor and alters the receptor state resulting in a biological response.<img src=\"images/agonistchart.png\" alt=\"Ago1 Answer\" style=\"max-height:100%; max-width:100%;\">",
    ...
    "<b>YES</b>, an agonist cannot induce an effect if the cell contains no functioning signalling pathways that link the activated receptor to the observed effect – when <i>&#947</i> = 0, agonist-induced effect = 0.  This effect can be observed using the visualiser.",
