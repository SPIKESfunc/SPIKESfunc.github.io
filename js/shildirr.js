...
"Typically NO.  However, under very limited conditions, the pA2 obtained for an irreversible antagonist may be an approximation of –logKB.  These limited conditions would include (1) at low levels of agonist-receptor occupancy (i.e. for high efficacy agonists AND when low levels of agonist-induced response are used to generate dose ratio values; Kenakin (2019), pp151-152), and when low concentrations of the irreversible antagonist are used (that generate low DR values (e.g. DR of 2-3) such that data points are close to the x-axis.  In many instances, the pA2 values obtained using irreversible antagonists will under-estimate the –logKB value (as slope of Schild plot likely to be greater than one), and thereby over-estimate the true affinity of the antagonist.",
