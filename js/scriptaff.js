...
//QUESTION BOX
var questionsAff = ["What is the principal effect produced by an Allosteric Antagonist (affecting agonist affinity) on an agonist dose-response curve?<br><i>Test this using the Dose Response Visualiser.</i>",
    ...
    "What is the impact of the Cooperativity Factor (&alpha;) for the Allosteric antagonist on Agonist dose-response curves?"];
...
var answersAff = ["Allosteric antagonists (affecting only agonist affinity) cause dose-dependent parallel shifts of the agonist dose-response to the right (since the antagonist has reduced the affinity of the agonist for the receptor, higher [agonist] must be used to achieve the same level of agonist binding). <div style='text-align:center'><video width='320' height='240' controls><source src='images/Allosteric Antag. affinity - cellular effect.mp4' type='video/mp4'></source></video></div><br> A feature of allosteric antagonists is their effect is <b>SATURABLE</b>, and the extent of the rightward shift of the agonist dose-response curve is <b>LIMITED</b> (up to a dose ratio of 1/α where α is the cooperativity factor). <div style='text-align:center'><video width='320' height='240' controls><source src='images/Allosteric Antag. affinity - agonist DR effect.mp4' type='video/mp4'></source></video></div><br> This is in contrast to a competitive antagonist where the rightward shift of the agonist dose-response curve is theoretically unlimited. This effect can be observed using the visualiser.",
    ...
    "<b>NO</b>, the inhibitory effects produced by an allosteric antagonist (affecting agonist affinity) are <b>LIMITED</b> and can always be overcome by increasing the [agonist]. Test this using the Dose Response Visualiser.",
    "The Cooperativity Factor &alpha; indicates the maximum effect produced by the allosteric antagonist on agonist affinity – a value of 0.1 indicates that the allosteric antagonist can produce up to a 10-fold reduction in agonist affinity (1/0.1). Observe the effects of changing the affinity and/or cooperativity factor (&alpha;) of the Allosteric Antagonist on the shape and position of the Agonist dose-response curve by moving the red slider along the grey bar to the right or left to increase or decrease its value, respectively."];
